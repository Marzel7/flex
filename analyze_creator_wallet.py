...
def analyze_creator_wallet(creator_address):
    ...
    if tx_data and isinstance(tx_data, dict) and 'data' in tx_data:
        ...
        print("  2. IMPORTANT: Store in .env file (NEVER commit to git!)")
        print("     Create ~/.env or local .env:")
        print("     SOLSCAN_API_TOKEN=your_api_key_here")
        print("  3. Load environment and run script:")
        print("     export $(cat .env | xargs)")
        print("     python analyze_creator_wallet.py")
        print()
        print("  OR set directly in terminal:")
        print("     export SOLSCAN_API_TOKEN=your_api_key_here")
        print("     python analyze_creator_wallet.py")
        print()
