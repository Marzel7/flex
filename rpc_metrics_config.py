...
class PlanConfig:
    ...
    CURRENT_USAGE = {
        "credits_used_today": 163661,             # Total credits consumed today
        "credits_remaining": 9836339_000_000,     # Remaining monthly budget (10M tier)
        "budget_start_date": "2026-03-07",   # Start of billing period
    }
