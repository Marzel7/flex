...
def preflight(a):
 try:
  ...
  assert a.contract_sha==CONTRACT and a.track_sha==TRACK and a.track_count==21594 and len(seeds)==100 and digest==a.manifest_sha and a.depth==2 and a.max_requests==5000 and a.wall_seconds==1800 and a.provider_env and os.environ.get(a.provider_env) and not a.mock and not Path(a.run_dir).exists()
