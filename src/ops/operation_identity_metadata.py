...
IDENTITIES = {
    ...
    "WATCHTOWER": {"human_name": "WATCHTOWER", "family": "Dynamic Treasury Route", "family_relation": "RELATED_OPERATION_TYPE", "infrastructure": "DYNAMIC_ROLE_INFRASTRUCTURE", "common_root": "NOT_PROVEN"},
}
