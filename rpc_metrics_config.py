...
CREDIT_SCHEDULE = {
    ...
    "getAccountInfo": 1,                        # Account lookup
    "getBalance": 1,                            # SOL balance check
...
class PlanConfig:
    ...
    CURRENT_USAGE = {
        "credits_used_today": 138849,             # Total credits consumed today
        "credits_remaining": 9861151_000_000,     # Remaining monthly budget (10M tier)
        "budget_start_date": "2026-03-06",   # Start of billing period
    }
