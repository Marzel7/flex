...
def construct_manifest(
    coverage, limit: int = 1_000, *, milestone: str = "OIP v2.1E"
) -> tuple[list[CoverageTarget], dict]:
    ...
    manifest = {"milestone": milestone, "selection_method": "MIGRATION_FIRST_STABLE_SHA256_PAIRED_V1",
