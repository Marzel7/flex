...
class PlanConfig:
    ...
    CURRENT_USAGE = {
        "credits_used_today": 0,             # Total credits consumed today
        "credits_remaining": 10_000_000,     # Remaining monthly budget (10M tier)
        "budget_start_date": "2026-03-02",   # Start of billing period
    }
