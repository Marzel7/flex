#!/usr/bin/env python3
"""
Verify risk score calculation and thresholds
"""
...
async def check_token(mint):
    ...
    print(f"\n{'='*70}")
    print(f"Risk Score Analysis: {mint[:20]}...")
    print(f"{'='*70}\n")
...
if __name__ == "__main__":
    # Test the token provided
    test_mint = "A6FJ12TYV8K79QovsWzkZEC5PWPD7EFzvC4JKZsypump"
    asyncio.run(check_token(test_mint))
